...
public class TransacaoApiController implements TransacaoApi {
	...
	public ResponseEntity<Void> alteraValorTransacao(
		...
		try {
			return service.atualiza(authorization, codigo, valor);
		} catch (Exception e) {
		...
		if (accept != null && accept.contains("application/json")) {
			try {
				return new ResponseEntity<Transacao>(objectMapper.readValue(
						"{  \"tipo\" : \"debito\",  \"data\" : \"2000-01-23T04:56:07.000+00:00\",  \"valor\" : 6.027456183070403,  \"id\" : 0}",
						Transacao.class), HttpStatus.OK);
			} catch (IOException e) {
	...
	public ResponseEntity<Void> excluiTransacao(
		...
		try {
			return service.exclui(authorization, codigo);
